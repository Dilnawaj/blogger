...
import { deletePostService, loadAllPosts, search } from "../../services/PostService";
import Post from "../../components/Post";
import PostBlogger from "./PostBlogger";
function NewFeedBloggers() {
  const pageSize = 10;
        ...
        <Col md={{ size: 12 }}>
          {isLoading ? (
            ...
            postContent?.content.map((post) => (
              ...
              <PostBlogger deletePost={deletePost} post={post} key={post.id} />
            ))
          )}
        </Col>
      </Row>
...
export default NewFeedBloggers;
