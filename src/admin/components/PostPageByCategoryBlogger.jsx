...
function PostPageByCategoryBlogger() {
  ...
  const handleGoBack = () => {
    const url =`/admin/categorie/${categorieId}` ;
     console.log("ggggg URLLLLLLLLLLLLLL",`bcategorie/${categorieId}` );
    navigate(url);
...
export default PostPageByCategoryBlogger;
