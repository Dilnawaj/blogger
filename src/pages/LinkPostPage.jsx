...
function LinkPostPage() {
  ...
  const handleGoBack = () => {
    ...
    console.log("Current URL", `/home?pageNumber=${pageNumber}&sortBy=${sortBy}`);
    //  window.location.reload();
    navigate(`/home?pageNumber=${pageNumber}&sortBy=${sortBy}`);
    //window.location.reload();
  };
  ...
  useEffect(() => {
    const currentUrl = window.location.pathname;
    console.log("Current URLLLLLLLLLLLLLL", `/home?pageNumber=${pageNumber}`);
    loadPost(postId)
      .then((data) => {
        console.log(data);
        setPost(data);
